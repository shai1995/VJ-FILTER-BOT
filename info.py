...
PICS = (environ.get('PICS', 'https://envs.sh/5fh.jpg')).split() #SAMPLE PIC
...
SUPPORT_CHAT = environ.get('SUPPORT_CHAT', 'MRADBOT_OFFICIALS') # Support Chat Link Without https:// or @
